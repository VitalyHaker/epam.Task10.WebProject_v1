...
public class UpdateBikeCommand implements Command {
    ...
    public void execute(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        ...
        if (brand != null && model != null && wheeldiam != null && price !=null) {
            try {
            	 bikeService.updateBike(idBike, brand, model, wheeldiam, appointment, sex, manufacturer, framesize, framematerial, 
                 		equipment, image, description, delSt, price, discountPct);
                request.getRequestDispatcher(ADD_BIKE_PAGE).include(request, response);
