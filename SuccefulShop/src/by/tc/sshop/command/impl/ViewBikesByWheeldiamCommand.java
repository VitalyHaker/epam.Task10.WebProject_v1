...
public class ViewBikesByWheeldiamCommand implements Command {
    ...
    private static final String ERROR_NO_BIKES = "Sorry, currently there are no bikes this wheel diameter.";
    
    private static final Logger LOGGER = LogManager.getLogger(ViewBikesByWheeldiamCommand.class.getName());

    private static final String GENRE = "genre";
    private static final String REQUEST_ATTRIBUTE = "all_Bikes";
    ...
    public void execute(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        ...
        try {
            Bikes = BikeService.viewBikesWheeldiam(genre);
